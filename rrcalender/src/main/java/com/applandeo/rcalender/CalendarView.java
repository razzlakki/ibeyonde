...
import com.applandeo.rcalender.listeners.OnNavigationButtonClickListener;
...
public class CalendarView extends LinearLayout {
    ...
    private void setAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            if (headerColor != 0) {
                findViewById(R.id.calendarHeader).setBackgroundColor(headerColor);
            }
    ...
    private void initAttributes() {
        ...
        if (mHeaderColor != 0) {
            findViewById(R.id.calendarHeader).setBackgroundColor(ContextCompat.getColor(mContext, mHeaderColor));
        }
    ...
    public void cleaAllEvents() {
        mCalendarPageAdapter.clearEventData();
        mCalendarPageAdapter.notifyDataSetChanged();
    }

    public void setEventClickLister(EventClickLister eventClickLister){
        mCalendarPageAdapter.setEventClickListener(eventClickLister);
    }

    public void setOnSelectDateListener(OnSelectDateListener onSelectDateListener) {
        this.onSelectDateListener = onSelectDateListener;
        mCalendarPageAdapter.setOnSelectDateListener(onSelectDateListener);
