...
import static com.applandeo.rcalender.CalendarView.CALENDAR_SIZE;
...
public class CalendarPageAdapter extends PagerAdapter {
    ...
    private EventClickLister eventClickListener;
...
//                mOnDayClickListener, mIsDatePicker, mTodayLabelColor, mSelectionColor));
    ...
    private void loadMonth(int position) {
        ...
        calendarDayAdapter.setEventClickListenr(eventClickListener);
        calendarDayAdapter.setOnSelectDateListener(onSelectDateListener);
    ...
    public void setEventClickListener(EventClickLister eventClickLister) {
        this.eventClickListener = eventClickLister;
    }
